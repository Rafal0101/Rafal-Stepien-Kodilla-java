package com.kodilla.patterns.patterns.stream.book;
...
public class BookTestSuite {
    ...
    public void testGetListUsingIntStream() {
        ...
        long number2OfBooksPublicatedAfter2007 = IntStream.range(0, books.size())
                .filter(n -> books.get(n).getYearOfPublication() > 2007)
                .count();

        Assert.assertEquals(3, numberOfBooksPublicatedAfter2007);
        Assert.assertEquals(3, number2OfBooksPublicatedAfter2007);
